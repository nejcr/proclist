...
vrstica1="student +[0-9]+ +xeyes + [0-9]+ *\(su\) +[-0-9]+ +[0-9]+\.[0-9]+ *"
vrstica2="student +[0-9]+ +xclock + [0-9]+ *\(su\) +[-0-9]+ +[0-9]+\.[0-9]+ *"
vrstica3="student +[0-9]+ +xlogo + [0-9]+ *\(su\) +[-0-9]+ +[0-9]+\.[0-9]+ *"
vrstica4="student +[0-9]+ +xeyes + [0-9]+ *\(su\) +[-0-9]+ +[0-9]+\.[0-9]+ *"
vrstica5="student +[0-9]+ +xclock + [0-9]+ *\(su\) +[-0-9]+ +[0-9]+\.[0-9]+ *"
